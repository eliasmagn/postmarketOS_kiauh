...
- Disabling Moonraker's PackageKit-driven system updates and skipping the policykit helper on apk-based installs so the Update Manager stays quiet when PackageKit is unavailable.
